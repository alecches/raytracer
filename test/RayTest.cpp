...
TEST(RayTest, HitPosT) {
	...
	Sphere s;
	std::vector<Intersection> ints{ Intersection(1,&s),Intersection{2,&s} };
...
TEST(RayTest, HitNegT) {
	...
	Sphere s;
	std::vector<Intersection> ints{ Intersection(-2,&s),Intersection{-1,&s} };
...
TEST(RayTest, HitMore) {
	...
	Sphere s;
	std::vector<Intersection> ints{ Intersection(5,&s),Intersection{7,&s},Intersection(-3,&s),Intersection{2,&s} };
